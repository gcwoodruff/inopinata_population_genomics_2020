...
#see elegans.sh to see how these files were made (lines 687-788)
...
#combine elegans and inopinata (see elegans_workflow.sh for elegans data; essentially same workflow; line 885)
